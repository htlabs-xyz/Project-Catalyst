...
**Status:** Tests 1–5 verified on hardware 2026-05-18; Tests 6 and 8 verified end-to-end on 2026-05-22 (unlock tx → ESP32 detection; 22 min long-run with stable heap); Test 7 (WiFi drop) pending operator router toggle.
