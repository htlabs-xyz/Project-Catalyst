...
| 2 | DHT22 direct sensor read | Python returns JSON with temperature and humidity | `npm test` returned `{"temperature": 31.4, "humidity": 79.7}` during final check | Pass | [`../media/logs/iot1-sensor-data-store/iot1-sensor-30.log`](../media/logs/iot1-sensor-data-store/iot1-sensor-30.log) |
| 3 | 30-sample real-world sensor stability run | 30 readings complete without sensor read failure | 30/30 readings succeeded from `04:41:15` to `04:42:35`; temperature range `31.5–31.6°C`, humidity range `79.0–79.3%` | Pass | [`../media/logs/iot1-sensor-data-store/iot1-sensor-30.log`](../media/logs/iot1-sensor-data-store/iot1-sensor-30.log) |
...
| 6 | Additional on-chain samples for statistics | Multiple confirmed txs can be generated using unique sensor asset names | Confirmed txs: `2e1cab...862f`, `329dc4...1585` | Pass | [`../media/logs/iot1-sensor-data-store/iot1-batch-2.log`](../media/logs/iot1-sensor-data-store/iot1-batch-2.log), [`../media/logs/iot1-sensor-data-store/evidence/iot1-batch-20260517213809.json`](../media/logs/iot1-sensor-data-store/evidence/iot1-batch-20260517213809.json) |
...
| 8 | Spend/update existing sensor UTxO after Mesh SDK upgrade | Reusing `dht22_sensor_01` updates the existing on-chain sensor datum without `PPViewHashesDontMatch` | Two consecutive updates confirmed after upgrading `@meshsdk/core` to `1.9.0-beta.103`; tx build fetched cost models from provider | Pass | [`../media/logs/iot1-sensor-data-store/iot1-mesh-beta103-update.log`](../media/logs/iot1-sensor-data-store/iot1-mesh-beta103-update.log), [765d5d...3ba9](https://preprod.cexplorer.io/tx/765d5d1d8c5d260899bf812e03bc8ab79da046c53337c3937fff74a9302b3ba9), [caad0c...d144](https://preprod.cexplorer.io/tx/caad0c3af2df35bda0cd75308c27d12cb3ad2c1972b133a85fb1cfe529ffd144) |

## 3. Evidence Links

- Demo video: [https://youtu.be/khH-3ZzBanU](https://youtu.be/khH-3ZzBanU)
- Terminal screenshot — 30 sensor reads: [`../media/screenshots/iot1-sensor-data-store/iot1-consistent-terminal-sensor-30.png`](../media/screenshots/iot1-sensor-data-store/iot1-consistent-terminal-sensor-30.png)
- Terminal screenshot — blockchain writes: [`../media/screenshots/iot1-sensor-data-store/iot1-consistent-terminal-blockchain-write.png`](../media/screenshots/iot1-sensor-data-store/iot1-consistent-terminal-blockchain-write.png)
- Terminal screenshot — summary metrics: [`../media/screenshots/iot1-sensor-data-store/iot1-consistent-terminal-summary.png`](../media/screenshots/iot1-sensor-data-store/iot1-consistent-terminal-summary.png)
- 30-sample sensor log: [`../media/logs/iot1-sensor-data-store/iot1-sensor-30.log`](../media/logs/iot1-sensor-data-store/iot1-sensor-30.log)
- Batch blockchain log: [`../media/logs/iot1-sensor-data-store/iot1-batch-2.log`](../media/logs/iot1-sensor-data-store/iot1-batch-2.log)
- Batch JSON evidence: [`../media/logs/iot1-sensor-data-store/evidence/iot1-batch-20260517213809.json`](../media/logs/iot1-sensor-data-store/evidence/iot1-batch-20260517213809.json)
- Mesh SDK cost-model update log: [`../media/logs/iot1-sensor-data-store/iot1-mesh-beta103-update.log`](../media/logs/iot1-sensor-data-store/iot1-mesh-beta103-update.log)
...
The following terminal-style screenshots are rendered from the real RP5 logs and transaction evidence using one consistent monospace font. The raw logs remain linked above for verification.

![IoT1 30 DHT22 sensor reads](../media/screenshots/iot1-sensor-data-store/iot1-consistent-terminal-sensor-30.png)

![IoT1 Cardano preprod write evidence](../media/screenshots/iot1-sensor-data-store/iot1-consistent-terminal-blockchain-write.png)

![IoT1 testing and performance summary](../media/screenshots/iot1-sensor-data-store/iot1-consistent-terminal-summary.png)
