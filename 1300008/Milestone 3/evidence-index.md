...
- GitHub-hosted image asset (under each template's `./media/` directory)
...
|---|---|---|---|---|---|---|
| 1 | DHT22 Sensor Data | Standalone IoT1 package | [iot1-sensor-data-store/comprehensive-testing-and-optimization.md](./iot1-sensor-data-store/comprehensive-testing-and-optimization.md) | [Watch](https://youtu.be/khH-3ZzBanU) | [terminal summary screenshot](./iot1-sensor-data-store/media/screenshots/iot1-consistent-terminal-summary.png), [30-read log](./iot1-sensor-data-store/media/logs/iot1-sensor-30.log), [batch log](./iot1-sensor-data-store/media/logs/iot1-batch-2.log), [Mesh beta.103 update log](./iot1-sensor-data-store/media/logs/iot1-mesh-beta103-update.log), [update tx](https://preprod.cexplorer.io/tx/765d5d1d8c5d260899bf812e03bc8ab79da046c53337c3937fff74a9302b3ba9) | Complete |
| 1 | DHT22 Sensor Data | Testing log | [iot1-sensor-data-store/testing-log.md](./iot1-sensor-data-store/testing-log.md) | [Watch](https://youtu.be/khH-3ZzBanU) | [sensor screenshot](./iot1-sensor-data-store/media/screenshots/iot1-consistent-terminal-sensor-30.png), [blockchain write screenshot](./iot1-sensor-data-store/media/screenshots/iot1-consistent-terminal-blockchain-write.png), [30-read log](./iot1-sensor-data-store/media/logs/iot1-sensor-30.log), [Mesh beta.103 update log](./iot1-sensor-data-store/media/logs/iot1-mesh-beta103-update.log), [update tx](https://preprod.cexplorer.io/tx/caad0c3af2df35bda0cd75308c27d12cb3ad2c1972b133a85fb1cfe529ffd144) | Complete |
...
| 2 | Smart Lock State Sync | Testing log | [iot2-sync-state-onchain/testing-log.md](./iot2-sync-state-onchain/testing-log.md) | [Watch](https://youtu.be/8k02ehV1r7Q) | [init-lock-tx-output](./iot2-sync-state-onchain/media/screenshots/init-lock-tx-output.log), [unlock-tx-output](./iot2-sync-state-onchain/media/screenshots/unlock-tx-output.log), [monitor-after-unlock](./iot2-sync-state-onchain/media/screenshots/monitor-after-unlock.log), [init tx](https://preprod.cexplorer.io/tx/b77d733d261fbb515d3e7201b17b32ae78f3559d92de101d67b778e3aebd24e2), [unlock tx](https://preprod.cexplorer.io/tx/1a4066911f8c563edb64d9d87bac42175f1fc1edad51e395d507ef53bc35e257) | Complete (Tests 1–4 Pass; Test 5 unauthorized signer by code review only) |
...
| 3 | Vending Machines (ESP32) | Testing log | [iot3-vending-machines/testing-log.md](./iot3-vending-machines/testing-log.md) | [Watch](https://youtu.be/L75_IOXbAu0) | [build-log-cold](./iot3-vending-machines/media/screenshots/build-log-cold.txt), [upload-log](./iot3-vending-machines/media/screenshots/upload-log.txt), [serial-monitor-boot](./iot3-vending-machines/media/screenshots/serial-monitor-boot.txt), [test6-unlock-serial](./iot3-vending-machines/media/screenshots/test6-unlock-serial.log), [test7-wifi-drop](./iot3-vending-machines/media/screenshots/test7-wifi-drop-window.log), [test8-long-run-22min](./iot3-vending-machines/media/screenshots/test8-long-run-22min.log), [unlock tx](https://preprod.cexplorer.io/tx/1a4066911f8c563edb64d9d87bac42175f1fc1edad51e395d507ef53bc35e257) | Complete (all 8 tests Pass) |
...
| 4 | Student NFC Identity | Testing log | [iot4-nfc-tag-identification/testing-log.md](./iot4-nfc-tag-identification/testing-log.md) | [Watch](https://youtu.be/79a9eahkA5k) | [PN532 init](./iot4-nfc-tag-identification/media/logs/import-and-hardware-check.log), [Card A valid](./iot4-nfc-tag-identification/media/logs/live-card-a-valid-after-env-response.json), [Card B second valid](./iot4-nfc-tag-identification/media/logs/live-card-b-valid-response.json), [Card C invalid](./iot4-nfc-tag-identification/media/logs/live-card-c-invalid-direct-result.json), [resilience tests](./iot4-nfc-tag-identification/media/logs/resilience-negative-tests.log), [web build after fix](./iot4-nfc-tag-identification/media/logs/web-build-after-fix.log) | Complete (runtime/log evidence; optional physical placement video can be added) |
| 4 | Student NFC Identity | Issue resolution | [iot4-nfc-tag-identification/issue-resolution.md](./iot4-nfc-tag-identification/issue-resolution.md) | n/a | 12 issues/hardening items documented: Raspberry Pi deployment, native deps, `cbor2<6` pin, PN532 init, endpoint path, Next/SWC mismatch, frontend audit hardening, Blockfrost credential fix, Card B reclassification, API disconnect, NFC unavailable, tx build preconditions | Complete |
| 4 | Student NFC Identity | Performance metrics | [iot4-nfc-tag-identification/performance-metrics.md](./iot4-nfc-tag-identification/performance-metrics.md) | n/a | Backend health 0.649738 s, no-card timeout 10.126943 s, Card A valid 1.241680 s, Card B valid 0.805728 s, Card C invalid 0.512392 s, API failure 1.595987 s, NFC unavailable 0.543229 s, web build 12.9 s, runtime ready 1083 ms, high-severity web audit 2 -> 0 | Complete |
| 5 | QR Code Supply Chain | Testing log | [iot5-qr-code-traceability/testing-log.md](./iot5-qr-code-traceability/testing-log.md) | [Watch](https://youtu.be/h_saOa3uWoo) | [create tx log](./iot5-qr-code-traceability/media/logs/create-product-tx-output.log), [update tx log](./iot5-qr-code-traceability/media/logs/update-product-tx-output-01.log), [burn tx log](./iot5-qr-code-traceability/media/logs/burn-product-tx-output.log), [create tx screenshot](./iot5-qr-code-traceability/media/screenshots/create-product-tx-output.png), [mint tx](https://preprod.cexplorer.io/tx/8c03ad9c) | Complete |
| 5 | QR Code Supply Chain | Issue resolution | [iot5-qr-code-traceability/issue-resolution.md](./iot5-qr-code-traceability/issue-resolution.md) | n/a | 10 issues documented across create/update/track/burn lifecycle (testnet latency, metadata formatting, QR scan freshness); lifecycle confirmed by create/update/burn txs in logs | Complete |
| 5 | QR Code Supply Chain | Performance metrics | [iot5-qr-code-traceability/performance-metrics.md](./iot5-qr-code-traceability/performance-metrics.md) | n/a | Lifecycle tx confirm times captured (mint 43.4 s, updates 73.8 s / 129.3 s, burn); QR-scan/throughput rows labelled first reliable measurement | Complete |
