...
This answer will be displayed on the Catalyst voting app, so voters will see it even if they do not open your proposal to read it in detail.

## [Solution Overview] Summarize your solution to the problem (200-character limit including spaces)
Focus on what you are going to do, or change to solve the problem. Avoid "There should be a way to..." and ensure "We will build a...!".
...
Here, provide links to your or your organization's website, repository, or marketing materials. Alternatively, provide links to any whitepaper or publication relevant to your proposal.
Note that this is additional information that voters and Community Reviewers might choose not to read. Attaching files does not mean you do not need to answer the questions in this form.

## [Project Dependencies] Does your project have any dependencies on other organizations, technical or otherwise
Does your project have any dependencies on other organizations, technical or otherwise?
List dependencies and prerequisites for your project's success. These are usually external factors (such as third-party suppliers, external resources, third-party software, etc.) that may cause a delay or represent a risk due to less control over resources.
In the case of third-party software, indicate whether you have the necessary licenses and permission to use such software.
...
Clearly state how your idea is new to Cardano.
...
On-Chain Prototype or MVP
Make sure your prototype or MVP is deployed or testable on-chain by the end of project phase.
Consider how the community could help test your prototype or MVP.

## Describe realistic measures of success, ideally with on-chain metrics.
Blockchain usage projections
Estimate how many users, transactions, or smart contract calls your project expects.
...
## Each milestone
Please follow this guideline (https://docs.projectcatalyst.io/current-fund/project-onboarding/milestone-based-proposals) to understand how to build your indicative milestones. Each milestone must have declared:
A. Milestone title (Enter the title for this milestone)
B. Milestone outputs (Describe the deliverables or outcomes for this milestone)
C. Acceptance criteria (Define the criteria for success in this milestone)
D. Evidence of completion (Specify the evidence that will demonstrate this milestone is complete)
