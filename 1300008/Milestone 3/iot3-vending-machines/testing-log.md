...
| 6 | Pump trigger on state change | Pump/relay activates when unlocked/trigger state detected; duration matches firmware default (~3 s) | End-to-end verified 2026-05-22: re-init locker on wallet-derived policy `14f654ab…de5676` (init tx `b77d733d`), re-flashed ESP32 with new `ASSET_UNIT`, submitted unlock tx `1a406691…35e257` (block 4738060, block_time 19:33:50.000 +07). ESP32 logged `>>> State changed: UNLOCKED` at 19:33:55.500 → trigger detection latency 5.5 s from on-chain confirmation. `Locked: false` printed continuously after. Pump GPIO line not connected during this capture (LED/relay observation TODO). | Pass | [test6-unlock-serial.log](../media/screenshots/iot3-vending-machines/test6-unlock-serial.log) (line 62 `>>> State changed: UNLOCKED`), [test6-unlock-tx-output.log](../media/screenshots/iot3-vending-machines/test6-unlock-tx-output.log), [init tx](https://preprod.cexplorer.io/tx/b77d733d261fbb515d3e7201b17b32ae78f3559d92de101d67b778e3aebd24e2), [unlock tx](https://preprod.cexplorer.io/tx/1a4066911f8c563edb64d9d87bac42175f1fc1edad51e395d507ef53bc35e257) |
| 7 | Reconnect / error behavior | Clear error or reconnect log on WiFi drop or API failure | Verified 2026-05-22: operator-induced router outage 20:20:53 → 20:25:36 (4 min 43 s). ESP32 logged `WiFi lost, reconnecting...` at 20:20:53.498 (within 46 ms of `BEACON_TIMEOUT`), repeated `reconnecting...` every ~5 s during outage, printed clean `Asset state error: Asset txs HTTP -1` on Blockfrost fetch failure during the gap, and resumed normal polling at 20:25:36.372 once AP returned — no crash, no missed datum after recovery | Pass | [test7-wifi-drop-window.log](../media/screenshots/iot3-vending-machines/test7-wifi-drop-window.log) (lines 1659 `WiFi lost, reconnecting...`, 1729 `Asset state error`, then resumed poll lines) |
| 8 | Long-run polling (15–30 min) | Polling stays responsive; free heap stable | 22 min uninterrupted run 2026-05-22 19:36:40 → 19:58:41: 806 successful polls, 22 heap samples (logged every 60 s via patched `src/main.cpp:99-103`), free heap 188,740–188,780 B (drift 40 B ≈ 0.02 % over 22 min); no errors / no missed polls | Pass | [test8-long-run-22min.log](../media/screenshots/iot3-vending-machines/test8-long-run-22min.log) |
