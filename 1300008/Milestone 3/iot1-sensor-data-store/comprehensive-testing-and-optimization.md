...
|---|---|---|---|
| 1 | 30 local DHT22 reads | 30/30 successful reads | [iot1-sensor-30.log](../media/logs/iot1-sensor-data-store/iot1-sensor-30.log) |
...
| 3 | Additional batch writes | 2 additional confirmed txs after batch fix | [iot1-batch-2.log](../media/logs/iot1-sensor-data-store/iot1-batch-2.log) |
| 4 | Batch JSON evidence | Partial JSON persisted after confirmed samples | [iot1-batch-20260517213809.json](../media/logs/iot1-sensor-data-store/evidence/iot1-batch-20260517213809.json) |
| 5 | Mesh SDK cost-model spend/update re-test | 2 consecutive updates to fixed `dht22_sensor_01` UTxO confirmed after upgrade to `@meshsdk/core@1.9.0-beta.103` | [iot1-mesh-beta103-update.log](../media/logs/iot1-sensor-data-store/iot1-mesh-beta103-update.log) |
| 6 | Milestone 2 demo video | End-to-end prototype demonstration | [YouTube](https://youtu.be/khH-3ZzBanU) |
| 7 | Terminal screenshot — 30 sensor reads | Visual terminal evidence with consistent monospace font | [iot1-consistent-terminal-sensor-30.png](../media/screenshots/iot1-sensor-data-store/iot1-consistent-terminal-sensor-30.png) |
| 8 | Terminal screenshot — blockchain writes | Visual terminal evidence with consistent monospace font | [iot1-consistent-terminal-blockchain-write.png](../media/screenshots/iot1-sensor-data-store/iot1-consistent-terminal-blockchain-write.png) |
| 9 | Terminal screenshot — summary | Visual terminal evidence with consistent monospace font | [iot1-consistent-terminal-summary.png](../media/screenshots/iot1-sensor-data-store/iot1-consistent-terminal-summary.png) |
