...
| 4 | Student NFC Identity | [testing-log.md](./iot4-nfc-tag-identification/testing-log.md) | [issue-resolution.md](./iot4-nfc-tag-identification/issue-resolution.md) | [performance-metrics.md](./iot4-nfc-tag-identification/performance-metrics.md) | Demo video, NFC workflow checklist |
...
|---|---|---|---|---|
| 1 | DHT22 Sensor Data | Raspberry Pi 5 reads DHT22 values and writes sensor data to Cardano preprod | Pass: 30/30 sensor reads succeeded; multiple preprod txs confirmed | [30-read log](./media/logs/iot1-sensor-data-store/iot1-sensor-30.log), [primary tx](https://preprod.cexplorer.io/tx/ff366f12472ce55b8a66b8a2cb8a1de10d561768adc64e70fba4b3ad383661bf), [video](https://youtu.be/khH-3ZzBanU) |
...
| 4 | Student NFC Identity | PN532 reads NFC tag and maps student identity metadata to Cardano records | Pass in Milestone 2 demo; re-validation checklist documented | [video](https://youtu.be/79a9eahkA5k), [testing log](./iot4-nfc-tag-identification/testing-log.md) |
...
| 4 | Student NFC Identity | NFC read inconsistency and metadata mismatch risk | Tag orientation, reader timing, and off-chain metadata formatting | Retry/read validation workflow, UID consistency checks, metadata schema verification |
...
| 4 | Student NFC Identity | NFC read and mint flow validated manually | Re-test matrix isolates NFC read, identity registration, and on-chain lookup performance | [performance metrics](./iot4-nfc-tag-identification/performance-metrics.md) |
...
- IoT1 sensor run: [`./media/logs/iot1-sensor-data-store/iot1-sensor-30.log`](./media/logs/iot1-sensor-data-store/iot1-sensor-30.log)
- IoT1 blockchain batch log: [`./media/logs/iot1-sensor-data-store/iot1-batch-2.log`](./media/logs/iot1-sensor-data-store/iot1-batch-2.log)
- IoT1 batch JSON: [`./media/logs/iot1-sensor-data-store/evidence/iot1-batch-20260517213809.json`](./media/logs/iot1-sensor-data-store/evidence/iot1-batch-20260517213809.json)
